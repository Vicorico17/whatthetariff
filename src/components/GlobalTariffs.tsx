...
export default function GlobalTariffs() {
  ...
  const sumActiveTariffs = activeTariffs.reduce((sum, tariff) => sum + parseFloat(String(tariff.tariff_rate || '0')), 0);
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8">
      ...
      <div className="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg mb-4">
        <span className="text-gray-700 dark:text-gray-300">Total Active Tariff Rate:</span>
        <span className="text-2xl font-bold text-yellow-700 dark:text-yellow-400">{sumActiveTariffs.toFixed(1)}%</span>
      </div>
